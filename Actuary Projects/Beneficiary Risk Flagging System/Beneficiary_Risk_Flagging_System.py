...
# Step 2: List of chronic condition columns
chronic_conditions = [
...
# Step 3: Count how many chronic conditions are present
t["CHRONIC_COUNT"] = t[chronic_conditions].apply(lambda row: sum(row == 1), axis=1)

# Step 4: Calculate total medical reimbursement
...
# Step 6: Flag as high-risk if 2 or more conditions are met
